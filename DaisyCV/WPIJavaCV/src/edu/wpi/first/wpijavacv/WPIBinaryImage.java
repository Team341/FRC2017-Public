...
public class WPIBinaryImage extends WPIImage {
     ...
     */
    public WPIBinaryImage(IplImage image) {
        super(image);
    }
    ...
    public WPIBinaryImage getAnd(WPIBinaryImage image2) {
        ...
        opencv_core.cvAnd(image, image2.image, result, null);
    ...
    public void and(WPIBinaryImage image2) {
        ...
        opencv_core.cvAnd(image, image2.image, image, null);
    }
    ...
    public WPIBinaryImage getOr(WPIBinaryImage image2) {
        ...
        IplImage result = IplImage.create(image.cvSize(), image.depth(), 1);
        opencv_core.cvOr(image, image2.image, result, null);
        return new WPIBinaryImage(result);
    }
    ...
    public void or(WPIBinaryImage image2) {
        ...
        opencv_core.cvOr(image, image2.image, image, null);
    }
    ...
    public void invert() {
        ...
        opencv_core.cvInvert(image, image);
    }
    ...
    public WPIBinaryImage getInverse() {
        ...
        IplImage result = IplImage.create(image.cvSize(), image.depth(), 1);
        opencv_core.cvInvert(image, result);
        return new WPIBinaryImage(result);
    }
    ...
    public void dilate(int iterations) {
        ...
        opencv_imgproc.cvDilate(image, image, null, iterations);
    }
    ...
    public WPIBinaryImage getDilated(int iterations) {
        ...
        IplImage result = IplImage.create(image.cvSize(), image.depth(), 1);
        opencv_imgproc.cvDilate(image, result, null, iterations);
        return new WPIBinaryImage(result);
    }
    ...
    public void erode(int iterations) {
        ...
        opencv_imgproc.cvErode(image, image, null, iterations);
    }
    ...
    public WPIBinaryImage getEroded(int iterations) {
        ...
        IplImage result = IplImage.create(image.cvSize(), image.depth(), 1);
        opencv_imgproc.cvErode(image, result, null, iterations);
        return new WPIBinaryImage(result);
    }
    ...
    public WPIContour[] findContours() {
        ...
        opencv_core.cvCopy(image, tempImage);
