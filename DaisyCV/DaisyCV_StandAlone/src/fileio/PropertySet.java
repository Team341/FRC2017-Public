...
public class PropertySet {
	...
	/**
	 * Add a new name-value pair to the set. Overwrites any existing properties
	 * of the same name.
	 *
	 * @param aKey
	 ...
	 *            the key
	 * @param aDefault
	 *            the default value to return in case of an error or inexistent
	 *            property
	 * @return the value represented as a string, or the default value if errors
	 *         occur
	 */
	 ...
	 *            the default value to return in case of an error or inexistent
	 *            property
	 * @return the value represented as a double, or the default value if errors
	 *         occur
	 */
	 ...
	 *            the default value to return in case of an error or inexistent
	 *            property
	 * @return the value represented as an int, or the default value if errors
	 *         occur
	 */
